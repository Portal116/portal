...
public class MemberPanel {
	...
	public static JPanel getPanel() {
		if (member == null) {
			...
			model = new DefaultTableModel(null, new String[] { "ID", "ÀÌ¸§", "ÀüÈ­¹øÈ£", "ÁÖ¼Ò" }) {
				@Override
...
//				}
			...
			ldlName.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 15));
			textName = new JTextField();
			textName.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 15));
			infoPanel_1.add(textName);
			textName.setColumns(10);
			JLabel lblPhone = new JLabel("\uC804\uD654\uBC88\uD638");
			lblPhone.setHorizontalAlignment(SwingConstants.CENTER);
			lblPhone.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 15));
			infoPanel_1.add(lblPhone);
			textPhone = new JTextField();
			textPhone.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 15));
			...
			lblAddress.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 15));
			textAddress = new JTextField();
			textAddress.setBounds(114, 6, 609, 27);
			addressPanel.add(textAddress);
			textAddress.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 15));
			...
			textFieldSelectCnt.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 15));
...
//			imageLabel.setPreferredSize(new Dimension(1184, 661));
	...
	private static void setInsert() {
		...
		try {
			...
			if (pstmt != null)
				pstmt.close();
			String error = "È¸¿ø Á¤º¸¸¦ Ãß°¡Çß½À´Ï´Ù.";
			...
			String error = "»óÇ° Á¤º¸¸¦ Ãß°¡ÇÏÁö ¸øÇß½À´Ï´Ù.";
			JLabel lblError = new JLabel(error);
			lblError.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 15));
	...
	private static void setDelete() {
		...
		try {
			...
			if (pstmt != null)
				pstmt.close();
			String error = "È¸¿ø Á¤º¸¸¦ »èÁ¦Çß½À´Ï´Ù.";
			JLabel lblError = new JLabel(error);
			lblError.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 15));
			dialog.showMessageDialog(null, lblError, "Successful", JOptionPane.PLAIN_MESSAGE);
		} catch (SQLException e1) {
			String error = "ÁÖ¹® ³»¿ªÀÌ ÀÖ´Â È¸¿øÀÌ¶ó »èÁ¦ÇÒ ¼ö ¾ø½À´Ï´Ù.";
			JLabel lblError = new JLabel(error);
			lblError.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 15));
			dialog.showMessageDialog(null, lblError, "Error", JOptionPane.PLAIN_MESSAGE);
		}
	...
	private static void setUpdate() {
		...
		try {
			...
			if (pstmt != null)
				pstmt.close();
			String error = "È¸¿ø Á¤º¸¸¦ °»½ÅÇß½À´Ï´Ù.";
			JLabel lblError = new JLabel(error);
			lblError.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 15));
			dialog.showMessageDialog(null, lblError, "Successful", JOptionPane.PLAIN_MESSAGE);
		} catch (Exception e1) {
			String error = "È¸¿ø Á¤º¸¸¦ °»½Å ÇÏÁö ¸øÇß½À´Ï´Ù.";
			JLabel lblError = new JLabel(error);
			lblError.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 15));
			dialog.showMessageDialog(null, lblError, "Error", JOptionPane.PLAIN_MESSAGE);
		}
