...
//   private static String[] col_name = { "ÁÖ¹® ¹øÈ£", "ID", "»óÇ° ¹øÈ£", "¼ö·®", "ÆÇ¸Å ³¯Â¥", "ÆÇ¸Å °¡°Ý" };
   ...
   public static JPanel getPanel() {
      ...
      if (order == null) {
         ...
         model = new DefaultTableModel(null, new String[] { "ÁÖ¹® ¹øÈ£", "ID", "»óÇ° ¹øÈ£", "¼ö·®", "ÆÇ¸Å ³¯Â¥", "ÆÇ¸Å °¡°Ý" }) {
...
//            Å¬¸¯ÇÒ ¶§ text¿¡ ¹ÝÈ¯
         ...
         JComboBox comboBoxTotal = new JComboBox(new String[] { "´ÜÀÏ", "Æ÷ÇÔ", "ÀÌ»ó", "ÀÌÇÏ" });
         comboBoxTotal.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 15));
